...
## Solución
La pista indica que tal vez el mismo procedimiento vuelva a funcionar por lo que uso la misma pagina para descifrar este mensaje obteniendo la siguiente bandera: 
